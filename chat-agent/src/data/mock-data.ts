...
export const MOCK_MESSAGES: Message[] = [
  ...
  },
  {
    ...
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 2 + 1000 * 30), // 2 hours ago + 30s
  },
  {
    id: '4',
    role: 'user',
  ...
  },
  {
    ...
    createdAt: new Date(Date.now() - 1000 * 60 * 4), // 4 mins ago
  },
];
  ...
  },
  {
    ...
    messages: [
        ...
        },
        {
            ...
            createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48 + 5000),
        }
    ],
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 48),
