...
## UI/UX Guidelines
- **Consistency**: Ensure the UI is consistent across the entire `uni-booking` project. Follow existing patterns and styles.
...
- `src/app/actions/bookings.ts` — criteria checks on task completion
