...
const Default = ({ className, size = 24, ...props }: SpinnerVariantProps) => (
  <LoaderIcon
...
const Circle = ({ className, size = 24, ...props }: SpinnerVariantProps) => (
  <LoaderCircleIcon
    className={cn("animate-spin", className)}
    size={size}
    {...(props as LucideProps)}
...
const Pinwheel = ({ className, size = 24, ...props }: SpinnerVariantProps) => (
  <LoaderPinwheelIcon
    className={cn("animate-spin", className)}
    size={size}
    {...(props as LucideProps)}
