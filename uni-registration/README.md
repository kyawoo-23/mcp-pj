This is the **Traditional UI (Course Registration)** app for the MCP research prototype. It provides a standard GUI workflow for course registration, backed by the shared Supabase database.
